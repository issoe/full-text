...
app = Flask(__name__)
CORS(app)  # Áp dụng CORS cho tất cả các route trong Flask app của bạn
...
data_directory = "/Users/khanhpq/Documents/HCMUT/DATN/search-main-be-2/draf_code/json_output"

es = Elasticsearch([{'host': '127.0.0.1', 'port': 9200, 'scheme': 'http'}])

# Load fine-tuned classification model
classification_model = BertForSequenceClassification.from_pretrained('/Users/khanhpq/Documents/HCMUT/DATN/search-main-be-2/fine_tuned_model/checkpoint-1000', num_labels=5)  
...
def convert_to_json():
    ...
    if uploaded_file:
        ...
        if filename.lower().endswith(".docx"):
            ...
            # return jsonify({"error": "[Done] Converted pdf to json"})
